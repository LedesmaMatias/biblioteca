...
public class NegLibros implements INegLibros {
	...
	public Result cargarTablaDefault() {
		...
		if(!librosDao.hayRegistros()) {
			...
			libros.add(new Libros("8493283614", "El ultimo deseo", new Date(System.currentTimeMillis()), "Español", 174, "La historia de Geralt de Rivia", generosLibro1, negAutores.obtenerPorId(3)));
			
			Set<Generos> generosLibro3 = new HashSet<Generos>();
			generosLibro3.add(negGeneros.obtenerPorDescripcion("Policial"));
			libros.add(new Libros("9789871512072", "Estudio en escarlata", new Date(System.currentTimeMillis()), "Español", 174, "El detective Sherlock Holmes y su compañero, el doctor Watson", generosLibro3, negAutores.obtenerPorId(2)));
			...
			libros.add(new Libros("8401011809", "Instinto Animal", new Date(System.currentTimeMillis()), "Español", 349, "Una maleta con un millon de dolares", generosLibro2, negAutores.obtenerPorId(1)));
