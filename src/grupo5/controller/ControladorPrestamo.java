...
public class ControladorPrestamo {
	...
	public ModelAndView eventoModificarPrestamo(Integer idPrestamo, Integer txtBiblioteca, String dateFecha, Integer txtDias, Integer txtCliente) {
		ModelAndView MV = new ModelAndView();
		MV.setViewName("Prestamos_Alta");
	...
	public ModelAndView eventoNuevoPrestamo(Integer txtBiblioteca, String dateFecha, Integer txtDias, Integer txtCliente) {
		ModelAndView MV = new ModelAndView();
		MV.setViewName("Prestamos_Alta");
		SimpleDateFormat formato = new SimpleDateFormat("yyyy-MM-dd");
		Date date = new Date();
